...
SECRET_KEY = 'django-insecure-1k2ea!lt3@3*rrx6qvr$2*g%&8km#l%ms-@oup*4tvx!)a8t(&'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / "myproject/myapp/templates/../myapp/static",
]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'myapp.permissions.IsAuthenticated',
    ],
}
